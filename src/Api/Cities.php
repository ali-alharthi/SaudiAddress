...
class Cities extends Api
{
    ...
    public function getId(int $cityId)
    {
        ...
        $key = array_search($cityId, array_column($this->response, 'Id'));
    ...
    public function getName($cityName)
    {
        ...
        $key = array_search($cityName, array_column($this->response, 'Name'));
    ...
    public function getGov($govName)
    {
        ...
        $keys = array_keys(array_combine(array_keys($this->response), array_column($this->response, 'GovernorateName')), $govName);

        foreach ($keys as $key) {
            $findings []= $this->response[$key];
        }
