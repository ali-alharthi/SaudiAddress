...
class AddressTest extends FunctionalTestCase
{
    ...
    {
        $addresses = $this->saudi->address()->search('9935', 1);
    ...
    public function it_can_verify_an_address()
    {
        ...
        $this->assertTrue($this->saudi->address()->verify(8228, 12643, 2121));
        sleep(5); // For development subscription
        $this->assertFalse($this->saudi->address()->verify(9999, 99999, 9999));
    }
    ...
    public function it_throws_an_exception_when_the_find_method_is_not_called_before_all()
    {
        ...
        $this->expectExceptionMessage('You need to call search() or find() methods first.');
